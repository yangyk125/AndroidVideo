 ...
 * @author fbeachler
 */
public class Dict extends PListObject implements Map<java.lang.String, PListObject> {
	...
	/**
	 * Get an Float configuration value for the given key.
	 * 
	 * @param key
	 *            The text of the key to look up in the configuration
	 *            dictionary.
	 * @return The Integer value of the specified key.
	 */
	public float getConfigurationNumber(java.lang.String key) {
		Object obj =  getConfigurationObject(key);
		if(obj instanceof Real) {
			return ((Real)obj).getValue().floatValue() ;
		}
		else if(obj instanceof Integer) {
			return ((Integer)obj).getValue().floatValue() ;
		}
		return 0.0f ;
	}
	...
	@Override
	public Set<java.util.Map.Entry<java.lang.String, PListObject>> entrySet() {
		return this.configMap.entrySet() ;
	}

	@Override
	public PListObject get(Object key) {
	...
	@Override
	public PListObject put(java.lang.String key, PListObject value) {
		return this.configMap.put(key, value) ;
	}

	@Override
	public void putAll(Map<? extends java.lang.String, ? extends PListObject> map) {
		this.configMap.putAll(map);
	}

	@Override
	public PListObject remove(Object key) {
	...
	@Override
	public Collection<PListObject> values() {
