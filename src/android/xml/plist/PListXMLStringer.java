...
public class PListXMLStringer {
	 ...
	 * 
	 */
	public PListXMLStringer(String val) {
	 ...
	 * @throws IOException
	 */
	public static PListXMLStringer convert(InputStream is) throws IOException {
		/*
		 ...
		 * produce the string.
		 */
		PListXMLStringer ret = new PListXMLStringer();
		if (is != null) {
