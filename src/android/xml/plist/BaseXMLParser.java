...
public abstract class BaseXMLParser {
	 ...
	 */
	protected PListXMLStringer PListXMLStringer;
	...
	public void initParser() {
		...
		try {
			...
			Log.e(
					PListXMLStringer.newBuilder().append(TAG).append("#parse")
	...
	public void parse(String xml) throws IllegalStateException {
		...
		Log.v(PListXMLStringer.newBuilder().append(TAG).append("#parse").toString(),
				"done parsing xml");
	}
